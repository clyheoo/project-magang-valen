                ...
                <head>
                    ...
                    @media (max-width: 767.98px) { .card:hover { transform: none; } }
                ...
                <div class="container-fluid">
                    ...
                    <script>
                        ...
                        // Fungsi toggle sidebar (untuk desktop dan mobile)
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            // Sidebar Toggle - Handle semua tombol toggle
                            document.addEventListener('click', function(e) {
                                // Tombol dengan ID sidebarToggle atau class sidebar-toggle-btn
                                ...
                                if (e.target.closest('#sidebarOverlay') || e.target.classList.contains('sidebar-overlay')) {
                                    e.preventDefault();
                                    closeMobileSidebar();
                                    return;
                                }
                            ...
                            // Section Navigation - tutup sidebar setelah klik di mobile
